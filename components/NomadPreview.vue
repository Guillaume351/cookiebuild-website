...
useSeoMeta({ title: () => language.value === 'fr' ? 'Nomad Wars — Bientôt disponible | Cookie Build' : 'Nomad Wars — Coming soon | Cookie Build', description: () => copy.value.intro, ogTitle: () => language.value === 'fr' ? 'Nomad Wars — Bientôt disponible' : 'Nomad Wars — Coming soon', ogDescription: () => copy.value.intro, ogImage: 'https://www.cookie-build.com/maps/nomad-oasis.webp', twitterCard: 'summary_large_image' });
