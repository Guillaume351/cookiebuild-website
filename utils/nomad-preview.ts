...
const existingCopy = {
  en: {
    ...
    steps: [
      ...
      { title: "Make your two passes count", text: "Visit districts for food, wood and ore. Everyone starts with the same basic kit; equipment is capped at iron. Common supply stocks refill once, at the announced start of the second pass; stronger rewards remain limited." },
      { title: "Meet in the middle", text: "After two passes around the arena, the safe zones converge toward the centre for a final fight. The last surviving player wins. If several players remain after the 90-second final, the match ends in a draw." },
    ],
  ...
  fr: {
    ...
    steps: [
      ...
      { title: "Profite de tes deux passages", text: "Traverse les quartiers pour trouver nourriture, bois et minerais. Tout le monde commence avec le même équipement de base, et la progression est plafonnée au fer. Les stocks courants reviennent une seule fois, au début annoncé du second passage ; les récompenses puissantes restent limitées." },
      { title: "Rendez-vous au centre", text: "Après deux passages autour de l’arène, les zones sûres convergent vers le centre pour le combat final. Le dernier joueur en vie gagne. S’il reste plusieurs survivants après les 90 secondes de finale, la partie se termine par une égalité." },
    ],
