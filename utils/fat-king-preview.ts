export const fatKingPreviewCopy = {
  fr: {
    ...
    steps: [
      ...
      { title: "Défendez la couronne", text: "Plus votre roi porte d’or, plus il marque… et plus il ralentit. La manche dure 15 minutes : le meilleur score gagne. À sa mort, un coéquipier vivant prend la relève : le rôle tourne, les points restent." },
    ],
  ...
  en: {
    ...
    steps: [
      ...
      { title: "Defend the crown", text: "A heavier king scores faster but moves slower. A round lasts 15 minutes: the highest score wins. When the king dies, a living teammate takes over. Your team keeps its points." },
    ],
