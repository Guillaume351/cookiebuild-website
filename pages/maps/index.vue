<template>
  <div class="space-y-12">
    <header class="max-w-3xl py-8">
      ...
      <p class="mt-4 text-zinc-400">Browse the published map snapshots by game, including the playable Fat King and Nomad Wars betas. Availability follows each game’s current rotation.</p>
    </header>
